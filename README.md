...
- [AI-Panther HPC User Guide](#ai-panther-hpc-user-guide)
  - [📚 Table of Contents](#-table-of-contents)
  - [1. Introduction](#1-introduction)
  - [2. Getting Started](#2-getting-started)
    - [Prerequisites](#prerequisites)
    - [Connecting to AI-Panther](#connecting-to-ai-panther)
      - [Method 1: VS Code with Remote-SSH (Recommended)](#method-1-vs-code-with-remote-ssh-recommended)
      - [Method 2: Command Line SSH](#method-2-command-line-ssh)
    - [Initial Setup](#initial-setup)
    - [Understanding AI-Panther's Resources](#understanding-ai-panthers-resources)
      - [Detailed GPU Information](#detailed-gpu-information)
  - [3. Working with SLURM (The Job Scheduler)](#3-working-with-slurm-the-job-scheduler)
    - [What is SLURM?](#what-is-slurm)
    - [Interactive Jobs](#interactive-jobs)
    - [Partitions](#partitions)
    - [Essential SLURM Commands](#essential-slurm-commands)
    - [More Interactive Job Examples](#more-interactive-job-examples)
    - [Request specific GPU node](#request-specific-gpu-node)
    - [Multiple GPUs (up to 4 per node)](#multiple-gpus-up-to-4-per-node)
  - [4. Using Jupyter Notebooks](#4-using-jupyter-notebooks)
    - [Automated Launch Script](#automated-launch-script)
    - [Manual Jupyter Setup](#manual-jupyter-setup)
    - [Accessing Jupyter](#accessing-jupyter)
      - [Option A: VS Code Remote-SSH (Recommended)](#option-a-vs-code-remote-ssh-recommended)
    - [Jupyter Best Practices](#jupyter-best-practices)
  - [5. Python Environments](#5-python-environments)
  ...
  - [6. File Management](#6-file-management)
    ...
    - [File Best Practices](#file-best-practices)
  - [7. Troubleshooting](#7-troubleshooting)
    - [Common Issues](#common-issues)
      - ["No idle nodes available"](#no-idle-nodes-available)
